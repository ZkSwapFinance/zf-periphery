...
contract RichesRafflePool is Ownable, ReentrancyGuard {
    ...
    function deposit(uint256 _amount) public nonReentrant {
        require(block.timestamp <= campaignEndTimestamp, "deposit: RichesRaffle Campaign Ended");
    ...
    function setTime(uint256 _lockedEndTime, uint256 _campaignEndTime) public onlyOwner {
        require(
            _lockedEndTime <= MAX_LOCKED_TIME,
            "setTime: _lockedEndTime > MAX_LOCKED_TIME"
        );
