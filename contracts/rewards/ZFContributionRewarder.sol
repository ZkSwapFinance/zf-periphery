...
contract ZFContributionRewarder is Ownable, ReentrancyGuard {
    ...
    uint256 public startTimestamp = 1695816000;
    uint256 public endTimestamp = 1709035200; // startTime + 5 months

    uint256 public zfPerSecond = 3.433 ether;
