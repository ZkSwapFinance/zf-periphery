...
contract ZFSupplementaryRewarder is Ownable, ReentrancyGuard {
    ...
    uint256 public startTimestamp = 1697810400;
    uint256 public endTimestamp = 1710943200; // startTime + 5 months

    uint256 public zfPerSecond = 0.152 ether;
